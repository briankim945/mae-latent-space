...
from util import optim_factory
...
def main(args):
    ...
    misc.load_model(args=args, model_without_ddp=model_without_ddp, optimizer=optimizer, loss_scaler=loss_scaler, to_restore=to_restore)
